  ...
  return (
    <footer className="bg-brand-slate text-white">
      <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8 py-8 flex flex-col gap-3">
        ...
        <p className="text-sm text-white/80">Leigh Woods, Bristol — youth athlete assessment</p>
        <div className="text-sm text-white/80">
          <p>Email: mike@kperformance.uk</p>
        </div>
        <p className="text-sm text-white/70">Safeguarding trained and experienced working with young athletes.</p>
